...
export const productsData: Product[] = [
  {
    ...
    longDescription: `Santeway L-Carnitine Carnipure, vücutta doğal olarak üretilen bir amino asit türevi olan L-karnitini
      vücuduna düzenli olarak kazandırmak isteyenler için geliştirilmiş bir gıda takviyesidir. Düzenli kullanımı, fiziksel performansın artmasına, egzersiz sonrası
    ...
    images: [
      "/hero-image.jpg",
      "/product-lcarnitine-front.png",
      "/product-lcarnitine-back.png",
    ],
    category: "Özel Takviyeler",
    saleLinks: {
      trendyol:
        "https://www.trendyol.com/santeway/l-carnitine-carnipure-60-kapsul-p-951850283?boutiqueId=61&merchantId=1137807",
      hepsiburada:
        "https://www.hepsiburada.com/l-carnitine-carnipure-60-kapsul-pm-HBC000096L99X?magaza=Santeway",
      amazon:
        "https://www.amazon.com.tr/Santeway-L-Carnitine-Carnipure-60-Kaps%C3%BCl/dp/B0FJM4TWSD/ref=sr_1_1?__mk_tr_TR=%C3%85M%C3%85%C5%BD%C3%95%C3%91&crid=1L95BPGLUNHCV&dib=eyJ2IjoiMSJ9.baWslxbCoCUBqBPkhzBr7Q.wxKkX-KDOMIEDDsDriPDm--0XIXJOB1N2yjdN2KS95c&dib_tag=se&keywords=santeway&qid=1754132690&sprefix=santeway%2Caps%2C769&sr=8-1",
    },
    features: {
      glutenFree: true,
    ...
    activeIngredients: ["L-Karnitin"],
    ingredients:
      "L-Karnitin, L-Tartarik asit, hidroksipropil metil selüloz (bitkisel kapsül), topaklanma önleyici: magnezyum stearat (yağ asitlerinin magnezyum tuzları).",
    ...
    netQuantity: "60 kapsül (30 günlük kullanım)",
    storageConditions:
      "Güneş ışığından uzak, serin ve kuru bir yerde ağzı kapalı olarak saklayınız.",
    usageRecommendation:
      "11 yaş ve üzeri yetişkinlerin aç karnına veya egzersize başlamadan 30 dakika önce günde 2 kapsül alması önerilir.",
    additionalInfo:
      "Şeker, tuz, nişasta içermez. Maya, buğday, gluten, soya ve süt ürünleri gibi potansiyel alerjenleri içermez. Yapay aroma, renklendirici, tatlandırıcı ve koruyucular kullanılmamıştır. Vegan ve vejetaryen bireylerin kullanımına da uygundur.",
    warnings: [
